...
## dblp
- seed 0: pred_cos=0.4809  copy_cos=0.5312  graph_avg_cos=0.3439  eff_rank=9.47  mean_pair_cos=0.171
- seed 1: pred_cos=0.3986  copy_cos=0.5206  graph_avg_cos=0.3439  eff_rank=10.08  mean_pair_cos=0.178
- seed 2: pred_cos=0.5296  copy_cos=0.4842  graph_avg_cos=0.2679  eff_rank=7.71  mean_pair_cos=0.212
- seed 3: pred_cos=0.5704  copy_cos=0.4264  graph_avg_cos=0.2494  eff_rank=6.30  mean_pair_cos=0.243
- seed 4: pred_cos=0.5194  copy_cos=0.5107  graph_avg_cos=0.3067  eff_rank=8.30  mean_pair_cos=0.208
...
- seed 3: pred_cos=0.3324  copy_cos=0.5572  graph_avg_cos=0.3449  eff_rank=5.42  mean_pair_cos=0.148
...
- seed 3: graph_cos=0.5704  seq_cos=0.3324  wilcoxon_p=3.947e-129  win_rate=0.978  n=800
- seed 4: graph_cos=0.5194  seq_cos=0.4559  wilcoxon_p=7.564e-100  win_rate=0.879  n=800
